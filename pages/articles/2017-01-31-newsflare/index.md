...
Newsflare  currently have a website, iOS and Android apps. They were all built within the early stages of the company’s development 3 years ago when they needed to focus on building up their portfolio of
clients. They have recently had a re-brand and are soon to launch a re-versioned mobile optimised website that is more open and inviting for video uploaders and in-keeping with new brand guidelines.

Their Apps were developed and launched with the intention of making the process of uploading videos breaking news videos easy and quick. Over the past couple of years , the attention has not been on the App due to other business requirements and a lack of budget and resource.
...
The long term objective is to grow their number of active existing members and to ultimately show a clear correlation between an App Uploader and the retention rate of the Uploader, therefore making the App easy, quick and as seamless as possible.
...
[Show digital version of affinity map]
