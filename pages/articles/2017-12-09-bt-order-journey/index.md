...
description: "An internal facing UX project which tackled ways of working that were deeply entrenched in remote working teams, resulting in a 40% increase in capacity for development demand tickets."
image: "./oj-home.jpg"
imageFormat: "center"
bgSize: "contain"
---
...
<div class="cf">
  <figure class="fl w-50 border-box pr3 mh0 mv3">
    <img src="./confirm-1.jpg" alt="Affinity Map" />
  </figure>

  <figure class="fl w-50 border-box pl3 mh0 mv3">
    <img src="./confirm-2.jpg" alt="Affinity Map" />
  </figure>
</div>
...
A few key areas were highlighted during my interviews with users:
...
<blockquote class="f3 measure lh-title i mid-gray bl bw2 pl4 border-box b--orange">“There is just so much historical data in there, some of its not really relevant any more,  which means one its confusing for us to decipher between whats there currently and whats completely redundant."<cite class="f6 db mt3 fs-normal orange">Experience Manager</cite></blockquote>
...
<blockquote class="f3 measure lh-title i mid-gray bl bw2 pl4 border-box b--orange">“We take the pages impacted then we go to each page and in each page we search for the BTR, we check the display logic and then from that we amend our component design."<cite class="f6 db mt3 fs-normal orange">Lead Developer</cite></blockquote>
...
<figure class="mh0 mv3 ba b--light-silver">
  <img class="border-box" src="./oj-home.jpg" alt="Affinity Map" />
</figure>
...
<figure class="mh0 mv3 ba b--light-silver">
  <img class="border-box" src="./experience-map-photo.jpg" alt="Workshoppers be workshoppin’" />
</figure>
...
<figure class="mh0 mv3 ba b--light-silver">
  <img class="border-box" src="./experience_map.jpg" alt="Affinity Map" />
</figure>
...
<figure class="w-60 mh0 mv3 ba b--light-silver">
  <img class="border-box" src="./0_1_1_-_confirm_your_order.png" alt="Affinity Map" />
</figure>
